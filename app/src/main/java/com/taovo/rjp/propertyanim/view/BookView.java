...
public class BookView extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if(curView != null) {
                curView.buildDrawingCache();
                mCurPageBitmap = curView.getDrawingCache();
                nextView.buildDrawingCache();
                mNextPageBitmap = nextView.getDrawingCache();
            }
        }
    ...
    public void setTextViews(View curView, View nextView) {
